...
Route::get('/incomequarterly','OrderController@incomeChartQuarterly')->name('product.order.income.quarterly');
...
Route::get('vnpay-payment', 'PaymentController@vnpay_payment')->name('vnpay.payment');
